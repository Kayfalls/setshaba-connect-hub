    ...
    <AdminLayout>
      <div className="p-6 space-y-6 bg-background min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-card">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-card-foreground">Acknowledged</CardTitle>
        ...
        <Card className="bg-card">
          <CardHeader>
            <CardTitle className="text-card-foreground">All Feedback</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            {feedback.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold text-card-foreground mb-2">No Feedback Yet</h3>
