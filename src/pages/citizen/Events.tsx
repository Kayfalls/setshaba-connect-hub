          ...
          {events.length === 0 ? (
            <Card className="content-card">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-bold text-card-foreground mb-2">No Events Scheduled</h3>
            ...
            events.map((event) => (
              <Card key={event.id} className="content-card">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="text-lg font-bold mb-2 text-card-foreground">{event.title}</CardTitle>
                      <CardDescription>
                        {event.description}
                      </CardDescription>
                    </div>
